-- ============================================================
-- Migration 001 : Création table VSWR
-- Description   : Alarmes VSWR (Voltage Standing Wave Ratio)
-- Date          : 2026
-- ============================================================

CREATE DATABASE IF NOT EXISTS incidents_reseau
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE incidents_reseau;

DROP TABLE IF EXISTS vswr;
...
CREATE TABLE vswr (
  ...
  COMMENT='Alarmes VSWR - Voltage Standing Wave Ratio';
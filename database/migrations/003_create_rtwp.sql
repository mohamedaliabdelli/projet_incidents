-- ============================================================
-- Migration 003 : Création table RTWP
-- Description   : Alarmes interférences radio (RTWP)
-- Date          : 2026
-- ============================================================

USE incidents_reseau;

DROP TABLE IF EXISTS rtwp;
...
CREATE TABLE rtwp (
  ...
  COMMENT='Alarmes RTWP - Received Total Wideband Power';